  ...
  return (
    <div className=" w-[min(2200px,75%)] mx-auto">
        ...
        <div className="md:w-10/12 mb-24 mt-10">
          ...
          >
            <span className="text-[#7ee787]">
              Introducing The Cornerstone of our Club, our Esteemed Faculty
              Advisor.{" "}
            </span>
            <br />
            Dr.(Mrs.) S. Sangeetha
      ...
      <div className="flex justify-between items-center md:space-x-10 max-md:flex-col ml-8">
        ...
        <div className="w-full md:w-2/3 border rounded-xl border-transparent flex justify-center items-center bg-[#161b22] lg:pl-8 lg:pr-8 lg:py-8 sm:p-10 p-8">
          <p className="text-sm lg:text-base lg:leading-10 mb-7 text-center lg:text-left font-medium text-[#7d8590]">
            Dr. (Mrs.) S.Sangeetha has obtained her Undergraduate degree in
            B.Sc. (Computer Science) from Avinashilingam University, Coimbatore,
            Postgraduate degree in M.C.A from the Bharathidasan University,
            Tiruchirappalli and Ph.D. from National Institute of Technology,
            Tiruchirappalli. She is working as Assistant Professor in the
            Department of Computer Applications, National Institute of
            Technology, Tiruchirappalli, Tamil Nadu, India from 2007 onwards
            with a great passion towards teaching and continuous learning.
            Feedback from students makes enthusiastic progress in her teaching
            career. She started her research career in 2008 and her field of
            research includes Information Extraction and Natural Language
            processing. She has published papers in International conferences
            and International Journals. She is a member of Computer Society of
      ...
      <motion.div
        ...
        viewport={{ once: false }}
        className=" md:ml-3  h-[160px] mt-[-20x] mb-[30px] w-[3px] rounded-md bg-gradient-to-b from-transparent via-[#ea6045] to-[#ffa28b]"
      ></motion.div>
    </div>
  );
};
      ...
      <div className="flex space-x-3 md:space-x-10">
        <div className="flex flex-col items-center">
          ...
          <motion.div
            ...
            whileInView={{ height: "100%" }}
            transition={{ duration: 0.4, delay: 0.6 }}
            className=" h-full w-[3px] mt-7 rounded-md bg-gradient-to-b from-[#e0413e]"
          ></motion.div>
        </div>
        <div className="md:w-10/12 mb-24">
          ...
          <motion.h3
            ...
            style={{ transitionDelay: "300ms" }}
          >
            <span className="text-[#d1623d]">
              Unleash The Power of Language With Our{" "}
            </span>{" "}
            AI-NLP CLUB{" "}
            <span className="text-[#d1623d]">
              Where Innovation Speaks Volumes In Every Algorithm And
              Conversation.{" "}
            </span>
          </motion.h3>
        </div>
      ...
      <div className="flex justify-between items-center md:space-x-10 max-md:flex-col ml-8">
        ...
        <div className="w-full md:w-2/3 border rounded-xl border-transparent flex justify-center items-center bg-[#161b22] lg:pl-8 lg:pr-8 lg:py-8 sm:p-10 p-8">
          <p className="text-sm lg:text-base lg:leading-10 mb-7 text-center lg:text-left font-medium text-[#7d8590]">
            ...
            is a club of NIT Trichy launched in 2018, initiated by the students
            of CA department under the guidance of Dr. S. Sangeetha. We welcome
            everyone to explore the emerging world of Artificial Intelligence
            along with its branch of Natural Language Processing. This club
            provides an opportunity for students to connect with the
            technologies of artificial intelligence by building up their skills
            in Natural Language Processing (NLP), machine learning (ML), etc.,
            and learn about creating systems that read, decipher, understand,
    ...
    <div className="w-[min(2200px,75%)] mx-auto bg-black">
      <div className="flex">
        ...
        <div className="  pt-0 mt-28 max-md:px-4 ml-4 md:ml-12">
          <h1 className="md:mt-24 lg:mt-28 sm:mt-10  z-2 max-md:mb-5 text-[48px] md:text-[72px] max-sm:leading-[60px] max-md:leading-[80px] lg:text-[80px] font-semibold text-white">
            {" "}
            ABOUT AI-NLP CLUB
          </h1>
          <p className=" z-1 text-[24px] md:text-[28px]  lg:text-[32px] leading-[30px] md:leading-[36px] lg:leading-[44px] mb-5 md:mb-12 md:10/12  lg:w-9/12 text-[#7d8590]">
            Step into our virtual haven, where the boundaries of language and
            technology blur. Welcome to our world of AI-NLP, where every
            interaction sparks new insights.
          </p>
        </div>
      </div>
    </div>
