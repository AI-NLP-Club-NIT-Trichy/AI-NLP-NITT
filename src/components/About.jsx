    ...
    <div className=' w-[min(2200px,75%)] mx-auto'>
      ...
      <div className='flex justify-between items-center md:space-x-10 max-md:flex-col ml-auto'>
        ...
        <div className='w-full md:w-2/3 border rounded-xl border-transparent flex justify-center items-center bg-[#161b22] lg:pl-8 lg:pr-8 lg:py-8 sm:p-10 p-8'>
          <p className='text-sm lg:text-base lg:leading-7 mb-7 text-center lg:text-left font-medium text-[#7d8590] max-w-lg lg:max-w-full'>
...
const Hero = (props) => {
  return (
    <div className='w-[min(2200px,75%)] mx-auto  bg-black'>
      <div className='flex'>
        <div className=' '>
          <img aria-hidden="true" className='object-cover object-center w-full h-auto' src="https://github.githubassets.com/images/modules/site/home-campaign/lines-hero.svg" width="437" height="637" alt="" />
